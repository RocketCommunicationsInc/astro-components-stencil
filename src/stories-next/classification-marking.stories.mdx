...
<Canvas>
    <Story
        parameters={{
            docs: { source: { code: '<rux-classification-marking classification="confidential"></rux-classification-marking>' } },
        }}
...
export const ClassificationMarkingBanners = (args) => {
  return html`
  <div
...
<Canvas>
    <Story
        parameters={{
            docs: { source: { code: '<rux-classification-marking classification="confidential">Button</rux-classification-marking>' } },
        }}
        name="Banners"
    >
        {ClassificationMarkingBanners.bind()}
    </Story>
</Canvas>

export const ClassificationMarkingTags = () =>  {
return html`
    <div
...
<Canvas>
    <Story
        parameters={{
            docs: { source: { code: '<rux-classification-marking classification="unclassified" tag></rux-classification-marking>' } },
        }}
        name="Tags"
    >
        {ClassificationMarkingTags.bind()}
    </Story>
</Canvas>
