...
<Canvas>
    <Story
        parameters={{
            docs: { source: { code: '<rux-classification-marking classification="unclassified"></rux-classification-marking>' } },
        }}
        name="Default"
    >
        {Default.bind()}
...
<Canvas>
    <Story
        parameters={{
            docs: { source: { code: '<rux-classification-marking classification="unclassified" label="custom"></rux-classification-marking>' } },
        }}
        name="With Label"
    >
        {WithLabel.bind()}
