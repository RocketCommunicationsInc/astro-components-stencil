...
<Meta title="Astro UXDS/Welcome/Contributing" />

# Contributing & Style Guide

The first purpose of this storybook is to standardize the way in which the Astro UXDS maintainers build, document and test components. This storybook may also be of use to developers utilizing the Astro UXDS in their space app experiences. To help facilitate both uses, we will maintain a level of consistency and quality in our documentation and component structure by adhering to best practices using <a href="https://eslint.org/" target="_blank">ESLint</a>, <a href="https://semver.org/" target="_blank">Semantic Versioning</a>, code review, and conventions as follows:

### When creating or updating Astro UXDS components:
